...
\def\cmp{%
  \mathchoice%
  {\xcmp\displaystyle{.8ex}{.03ex}}% displaystyle
  {\xcmp\textstyle{.8ex}{.03ex}}% textstyle
  {\xcmp\scriptstyle{.16ex}{.43ex}}% scriptstyle
  {\xcmp\scriptscriptstyle{.11ex}{.35ex}}% scriptscriptstyle
}
...
\def\xcmp#1#2#3{\mathbin{\ooalign{%
      \raise #2\hbox{\pdfliteral{0 1 0 rg}$#1-$\pdfliteral{0 g}}\cr
      \lower #3\hbox{\pdfliteral{1 0 0 rg}$#1+$\pdfliteral{0 g}}%
  }}}
